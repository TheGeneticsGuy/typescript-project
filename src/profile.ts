...
const profileEmailInput = document.getElementById('profileEmail') as HTMLInputElement | null;
const profileNameInput = document.getElementById('profileName') as HTMLInputElement | null;
const profileBioTextarea = document.getElementById('profileBio') as HTMLTextAreaElement | null;
const profileMessageP = document.getElementById('profileMessage') as HTMLParagraphElement | null;
const profileErrorP = document.getElementById('profileError') as HTMLParagraphElement | null;
const loadingDiv = document.getElementById('loading-profile') as HTMLDivElement | null;
...
const getUserProfileCallable: HttpsCallable<undefined, GetUserProfileResponse> = httpsCallable(functions, 'getUserProfile');
...
const updateUserProfileCallable: HttpsCallable<UpdateUserProfileData, UpdateUserProfileResponse> = httpsCallable(functions, 'updateUserProfile');
